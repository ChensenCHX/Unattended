...
namespace InGameTextEditor
{
    ...
    public class Line
    {
        ...
        GameObject CreateTextBlockGameObject(TextBlock textBlock)
        {
            ...
            textComponent.font = textEditor.font;
            textComponent.fontSize = textEditor.fontSize;
            textComponent.lineSpacing = textEditor.lineSpacing;
            textComponent.fontStyle = textEditor.mainFontStyle;
            textComponent.color = textEditor.mainFontColor;
            textComponent.alignment = TextAlignmentOptions.TopLeft;
            textComponent.text = blockText;
            ...
            rectTransform.pivot = new Vector2(0f, 1f);
            rectTransform.anchoredPosition = new Vector2(textEditor.mainMarginLeft + textBlock.offset.x, -textEditor.mainMarginTop + verticalOffset + textBlock.offset.y);
            rectTransform.sizeDelta = new Vector2(textEditor.CharacterWidth * (blockText.Length + 1), textEditor.CharacterHeight);
        ...
        GameObject CreateLineNumberGameObject()
        {
            ...
            textComponent.fontSize = textEditor.fontSize;
            textComponent.lineSpacing = textEditor.lineSpacing;
            textComponent.fontStyle = textEditor.lineNumberFontStyle;
            textComponent.color = textEditor.lineNumberFontColor;
