...
namespace InGameTextEditor
{
    ...
    public class TextEditor : MonoBehaviour
    {
        ...
        /// </summary>
        public FontStyles mainFontStyle = FontStyles.Normal;
        ...
        /// </summary>
        public FontStyles lineNumberFontStyle = FontStyles.Normal;
        ...
        /// </summary>
        public FontStyles tooltipFontStyle = FontStyles.Normal;
        ...
        public void ShowTooltip(string message, Vector2 position)
        {
            ...
            float tooltipTextWidth = tooltipText.preferredWidth;
            float tooltipTextHeight = tooltipText.preferredHeight;
        ...
        public void UpdateFont()
        {
            ...
            lineNumberText.alignment = TextAlignmentOptions.TopRight;
            ...
            for (int i = 1; i < length; i++)
                stringBuilder.Append("\nA");
            var tmpString = stringBuilder.ToString();
            var charSize = mainText.GetPreferredValues(tmpString) / length;
            characterWidth = charSize.x;
            characterHeight = charSize.y;
            ...
            //         continue;
            //     var tmpCharacterWidth = mainText.GetPreferredValues(c.ToString()).x;
        ...
        bool ExecuteOperation(IOperation op)
        {
            return op switch
            {
                ...
                CopyOperation operation => ExecuteCopyOperation(operation),
                CutOperation operation => ExecuteCutOperation(operation),
                DeleteOperation operation => ExecuteDeleteOperation(operation),
                DeleteTextOperation operation => ExecuteDeleteTextOperation(operation),
                FindOperation operation => ExecuteFindOperation(operation),
                InsertCharacterOperation operation => ExecuteInsertCharacterOperation(operation),
                InsertTextOperation operation => ExecuteInsertTextOperation(operation),
                ModifyIndentOperation operation => ExecuteModifyIndentOperation(operation),
                MoveCaretOperation operation => ExecuteMoveCaretOperation(operation),
                PasteOperation operation => ExecutePasteOperation(operation),
                PlaceCaretOperation operation => ExecutePlaceCaretOperation(operation),
                RebuildLinesOperation operation => ExecuteRebuildLinesOperation(operation),
                RedoOperation operation => ExecuteRedoOperation(operation),
                SelectAllOperation operation => ExecuteSelectAllOperation(operation),
                SetSelectionOperation operation => ExecuteSetSelectionOperation(operation),
                SetTextOperation operation => ExecuteSetTextOperation(operation),
                UndoOperation operation => ExecuteUndoOperation(operation),
                _ => throw new UnityException("Invalid operation")
            };
        }
